...
html+=`
<div class="flex flex-col" style="position:relative;z-index:999999!important;overflow:visible!important;">
<div class="card-micro ${cor}" onclick="abrirDetalhesResumo('${itemClick}')" style="position:relative;z-index:999999!important;overflow:visible!important;padding:12px;min-height:120px;display:flex;flex-direction:column;align-items:center;justify-content:center;">
